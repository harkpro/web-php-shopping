...
<div class="card-header" id="headingFor">
    <h5 class="mb-0">
        <button class="btn btn-outline-primary w-100 collapsed" data-toggle="collapse" data-target="#collapseFor" aria-expanded="false" aria-controls="collapseFor">Tùy biến liên kết</button>
    </h5>
</div>
