		...
		<div class="w-100 container-fluid " >
			<div class="card">
				<div class="card-header">
					<div class="row">
						<div class="col-md-6"><strong class="text-danger">user Trash</strong></div>
						<div class="col-md-6 text-right">
							<a class="btb btn-danger btn-sm" href="index.php?option=user">Exit</a>
						</div>
					</div>
				</div>
					...
					<table id="myTable" class="table table-inverse table-hover table-bordered">
						...
						<tbody>
							...
							<tr>
								...
								<td class="text-danger"><a class="btn btn-sm btn-warning" href="index.php?option=user&cat=retrash&id=<?php echo $id; ?>=<?php echo $id; ?>" > K.Phục </a>
									<a class="btn btn-sm btn-danger" href="index.php?option=user&cat=delete&id=<?php echo $id; ?>" > Xóa vv </a></td>
